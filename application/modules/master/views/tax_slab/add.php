                                    ...
                                    <div class="m-3-percentage">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                echo form_input(array('name' => 'add_name', 'maxlength' => '25', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'Tax Slab Name', 'value' => !empty($postvalue) ? $postvalue : $name, 'onkeyup' => 'validate_character(this)'));
                                                ?>
                                                <label class="error">
