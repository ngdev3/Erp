         ...
         <div class="card">
           ...
           <div class="card-body">
             ...
             <div class="col-6 pull-right">
               <a href="<?php echo base_url('master/item/add'); ?>" id="back-btn" class="btn btn-success">Add item</a>
             </div>
         ...
         buttons: {
           confirm: {
             ...
             action: function() {
               $.ajax({
                 type: "POST",
                 url: "<?php echo site_url("master/item/deletedata") ?>",
         ...
         buttons: {
           confirm: {
             ...
             action: function() {
               $.ajax({
                 type: "POST",
                 url: "<?php echo site_url("master/item/restoreData") ?>",
                 data: csrf_name + '=' + csrf_token + '&id=' + id,
                 success: function(data) {
